...
insert into project_team (project_id, employee_code) values
('d5436fd9ec184fe4a0402d66992be407','emp1'),
('0b5af6c17acb4ab0a3812a670daa1e42','emp1'),
('0b5af6c17acb4ab0a3812a670daa1e42', 'emp2');
insert into Time_Entry (id, version, employee_code, project_code, task_code, status, status_updated_by, status_reason, description, period, date, deleted, created_by, created) values
('56269d672e0b44e58c9541d2b20d7a75',0,'emp1','ECS', 'DEV_ECS', 'NEW','system', 'Dummy data','Batch and Support',500, CURRENT_DATE, FALSE,'system',CURRENT_TIMESTAMP),
('94b97da909e44aab9816913e109463a7',0,'emp1','ECS', 'ANL_ECS', 'NEW','system', 'Dummy data','Batch and Support',1800, CURRENT_DATE, FALSE,'system',CURRENT_TIMESTAMP),
('68cb92b9e00b413a963298f575543428',0,'emp2','RSM', 'DEV_RSM', 'NEW','system', 'Dummy data',NULL,36000, CURRENT_DATE, FALSE,'system', CURRENT_TIMESTAMP);
insert into Status_History (id, version, status, status_updated_by, status_update_reason, entry_id, time_stamp, deleted, created_by, created) values
('082042d0f5d34b7f949c33d112d95847',0,'NEW','system', 'Dummy data','56269d672e0b44e58c9541d2b20d7a75', CURRENT_TIMESTAMP, FALSE, 'system', CURRENT_TIMESTAMP),
('79f111acdb0d4959b1fd2544fca91b71',0,'NEW','system', 'Dummy data','94b97da909e44aab9816913e109463a7', CURRENT_TIMESTAMP, FALSE, 'system', CURRENT_TIMESTAMP),
('78f58a50ecb3462f9cd22d91d42604f9',0,'NEW','system', 'Dummy data','68cb92b9e00b413a963298f575543428', CURRENT_TIMESTAMP, FALSE, 'system', CURRENT_TIMESTAMP);
